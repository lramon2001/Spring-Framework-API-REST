...
public class SwaggerConfig {
    ...
    private static final String CONTATO_EMAIL = "lucasoliveirainor3105@gmail.com";
    private static final String CONTATO_URL = "https://github.com/lramon2001";
    private static final String CONTATO_NOME = "Lucas Ramon";
    private static final String API_VERSAO = "1.0.0";
    private static final String API_DESCRICAO = "API de Gerenciamento de Projetos";
    private static final String API_TITULO = "LR projetos";
    private static final String PACOTE_BASE = "br.com.lucasramon.lrprojetos.api";
